...
$(document).ready(function() {
    setTimeout(function() {
        ...
        var ip1 = "";
        $("#chart1-button").click(function () {
          ip1 = $("#chart1").val();
        });
        var ip2 = "";
        $("#chart2-button").click(function () {
          ip2= $("#chart2").val();
        });
        $(function() {
          var data = []
          ...
          function getNewSeries() {
              var requests = $.get('/plot/' + ip1);
              requests.done(function (result) {
                  // Add the Point
                  data.push({ x: result[0], y: result[2] })
              });
          }
          ...
          var chart = new ApexCharts(
              document.querySelector("#press-chart1"),
              options
          );
        ...
        $(function() {
            ...
            function getNewSeries() {
                ...
                requests.done(function (result) {
                    // Add the Point
                    data.push({ x: result[0], y: result[1] })
                });
            }
            ...
            var chart = new ApexCharts(
                document.querySelector("#temp-chart1"),
                options
            );
        ...
        $(function() {
          ...
          var chart = new ApexCharts(
              document.querySelector("#press-chart2"),
              options
          );
        ...
        $(function() {
            ...
            var chart = new ApexCharts(
                document.querySelector("#temp-chart2"),
                options
            );
